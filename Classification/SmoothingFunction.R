...
STKernSmCrime <- function(CrimeData,Query,Grid,raster,window.t,kernel.x,kernel.y,kernel.t,isInPoly,prj){
...
# Spatial kernerl smoothing
SpKernSmCrime <- function(CrimeData,Grid,raster,kernel.x,kernel.y,isInPoly,prj){
...
MapCount <- function(Data,Attr,r,isInCity,fun=sum){
